...
class MergedVideoPlayer extends StatefulWidget {
  final String videoAssetPath;

  const MergedVideoPlayer({super.key, required this.videoAssetPath});

  @override
  _MergedVideoPlayerState createState() => _MergedVideoPlayerState();
}
...
class _MergedVideoPlayerState extends State<MergedVideoPlayer> {
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              title: Text(
                                index != 0 ? 'See water falls' : 'See beach',
